...
export NOBACKUP="/nobackupp12/esi_sar/581/s2037"
...
/home4/esi_sar/verdi/bin/celery worker --app=hysds --concurrency=1 --loglevel=INFO -Q new_aria-standard_product-s1gunw-topsapp-pleiades_s2037 -n $WORKER_ID -O fair --without-mingle --without-gossip --heartbeat-interval=60 >> $LOGFILE 2>&1 &
#
